...
document.addEventListener("DOMContentLoaded", function () {
    const respostaCorreta = "resposta-b"; // Defina a resposta correta
    const proximaPergunta = "pergunta12.html"; // Link para a próxima pergunta
    ...
    botoes.forEach(botao => {
        botao.addEventListener("click", function () {
            botoes.forEach(b => b.disabled = true); // Desativa os botões após resposta
